...
const Dashboard = ({ user, problemStats, streakData, selectedPlatform, onPlatformChange, onLogout, updateProblemStats, updateStreakData }) => {
  ...
  return (
    <div className="popup-page !py-2 !px-2 overflow-y-auto">
      <div className={`w-full flex flex-col gap-2 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        {/* Header */}
        <div className="flex justify-between items-center gap-2 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              <h1 className="text-sm font-bold text-white truncate">{user?.displayName || 'AlgoGit User'}</h1>
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            <select
              ...
              className="bg-white/10 border border-white/20 rounded-lg px-1.5 py-0.5 text-white text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
            >
            ...
            <button
              onClick={onLogout}
              className="p-0.5 bg-white/10 hover:bg-white/20 rounded-lg transition-colors"
              title="Logout"
            >
        ...
        <div className="grid grid-cols-4 gap-1.5">
          {/* Total Problems */}
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-2 text-white shadow-lg">
          ...
          {/* Easy Problems */}
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-2 text-white shadow-lg">
            <div className="flex items-center justify-between mb-0.5">
          ...
          {/* Medium Problems */}
          <div className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-lg p-2 text-white shadow-lg">
            <div className="flex items-center justify-between mb-0.5">
          ...
          {/* Hard Problems */}
          <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-lg p-2 text-white shadow-lg">
            <div className="flex items-center justify-between mb-0.5">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-2 border border-white/20">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-lg p-1.5 text-white">
                <div className="flex items-center gap-1">
                  <span className="text-xs">🔥</span>
                  <div>
                    <div className="text-[10px] text-orange-100">Current</div>
                    <div className="text-sm font-bold">{streakData?.currentStreak || 0}</div>
                  </div>
                </div>
              </div>

              {/* Longest Streak */}
              <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg p-1.5 text-white">
                <div className="flex items-center gap-1">
                  <span className="text-xs">🏆</span>
                  <div>
                    <div className="text-[10px] text-purple-100">Longest</div>
                    <div className="text-sm font-bold">{streakData?.longestStreak || 0}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-0.5">
              {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => (
                <div
                  key={day}
                  className={`w-6 h-6 rounded flex items-center justify-center font-bold text-xs transition-all hover:scale-110 cursor-pointer ${getStreakColor(day)}`}
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-2 border border-white/20">
          <h2 className="text-xs font-bold text-white mb-1.5">Progress Overview</h2>
        ...
        <div className="flex gap-1 bg-white/5 p-0.5 rounded-lg">
          {['overview', 'achievements', 'settings'].map((tab) => (
            <button
              ...
              className={`flex-1 py-1 px-1.5 rounded-md font-medium text-xs transition-all ${
                activeTab === tab
        ...
        {activeTab === 'overview' && (
          <>
            ...
            <div className="grid grid-cols-3 gap-1.5">
              <button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white p-1.5 rounded-lg transition-all transform hover:scale-105 flex flex-col items-center justify-center gap-0.5">
              ...
              <button className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white p-1.5 rounded-lg transition-all transform hover:scale-105 flex flex-col items-center justify-center gap-0.5">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white p-1.5 rounded-lg transition-all transform hover:scale-105 flex flex-col items-center justify-center gap-0.5"
              >
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Footer */}
        <div className="text-center text-gray-400 text-xs mt-auto pt-1">
      ...
      {showUrlEdit && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-lg p-3 w-full border border-white/20">
